    ...
    <script type="text/javaScript" language="javascript" defer="defer">
    	$(document).ready(function(){
    		$(".dropdown-menu li").click(function(){    		  	  
   		  	  $(this).parents(".btn-group").find('.selection').html(
   		  	  $(this).text());
   		 	});  
	    });
        ...
        <div id="content_pop">
        	...
        	<div class="btn-group">
				<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
			      <span class="selection">선택하세요</span>&nbsp;<span class="caret"></span>
			    </button>
			    <ul class="dropdown-menu" role="menu">
			      <li><a href="#" value="1">NAME</a></li>
			      <li><a href="#" value="2">ID</a></li>
			    </ul>			    
			</div>
		    <div class="form-group">
			  <input type="text" class="form-control" placeholder="Search">
			</div>
			<button type="submit" class="btn btn-default" onclick="javascript:fn_egov_selectList();">Search</button>
        	<!-- List -->
        	<div id="table">
